...
import '../../presentation/feature/announcement/pages/announcement_listing_page.dart';
...
import '../../presentation/feature/ostrum/pages/ostrum_page.dart';
...
class AppRouter extends RootStackRouter {
  ...
  List<AutoRoute> get routes => [
        ...
        AutoRoute(page: OstrumRoute.page),
        ...settingsRoutes,
